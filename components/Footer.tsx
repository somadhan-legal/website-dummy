        ...
        <div className="bg-brand-600 rounded-2xl px-6 sm:px-10 py-8 sm:py-10 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-center sm:text-left">
              <h2 className={`font-serif font-medium text-xl sm:text-2xl text-white mb-1.5 ${language === 'bn' ? 'leading-[1.4]' : ''}`}>
            ...
            <button
              onClick={() => {
                trackCTAClick('join_waitlist', 'footer_cta');
                onOpenWaitlist();
              }}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8">
          ...
          <div className="col-span-2 md:col-span-4">
            ...
            <div className="bg-white rounded-xl border border-slate-100 p-4 shadow-sm">
              ...
              <button
                onClick={() => {
                  trackCTAClick('notify_me', 'footer_app_card');
                  onOpenWaitlist();
                }}
        ...
        <div className="mt-10 pt-6 border-t border-slate-200">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-5">
            ...
            {/* Ask AI about Somadhan */}
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-[11px] text-slate-400 mr-0.5">
                {language === 'bn' ? 'AI-কে জিজ্ঞাসা করুন' : 'Ask AI'}
              </span>
              {[
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-medium bg-white border border-slate-200 text-slate-500 hover:border-brand-300 hover:text-brand-600 hover:shadow-sm hover:-translate-y-px transition-all duration-200"
                >
                  {ai.name}
